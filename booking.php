...
<body>
  ...
  <form action="\OnlineSalon\partials\_booking.php" method="post"
    ...
    <a href="#" onclick="openPopup();"
      style="text-decoration: none;font-size:12px; background-color: black; color: white; display: inline-flex; width: 15px; height: 15px; border-radius: 50%; padding-bottom: 15px; justify-content: center; float:right;">
      <b>i</b>
    </a>
